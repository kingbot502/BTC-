"""
BTC Bot Backtester (Full Logic — Phase 1 + Volume + HTF + Candlestick)
------------------------------------------------------------------------
...
HOW TO RUN:
  ...
  3. Results print to console, plus a full per-signal CSV
     (backtest_btc_results.csv) including the confidence score logged at
...
def run_backtest():
    ...
    print(f"\n=== BTC/USDT bot — full current logic ===")
    ...
    if results_log:
        ...
        print("\nFull signal-by-signal log saved to backtest_btc_results.csv")
